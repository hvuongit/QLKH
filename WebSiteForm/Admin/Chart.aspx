...
<body>
    <script>
        function Check() {
            ...
            var ten = document.getElementById('MaKQ').value;
            var email = document.getElementById("MaHV").value;
            var addr = document.getElementById("MaCTKH").value;
            var bd = document.getElementById("ThoiGian").value;
            var phone = document.getElementById("GhiChu").value;
            var phone = document.getElementById("HinhThuc").value;
            var phone = document.getElementById("TrangThai").value;
